...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="index.html">N E D E R G E</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Mon énergie</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">Consulter les énergies disponibles</a></li>
              <li><a href="#">Commander une énergie</a></li>
    ...
    <div class="container">
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Nederge</span></strong>. Tous droits réservés
          </div>

        </div>
        <div class="social-links text-center text-md-right pt-3 pt-md-0">
          <div class="credits">
            Projet effectué par <b>HADID Hocine </b>&<b> CHEMIN Pierre</b></a> <br>
          </div>
        </div>
      </div>
