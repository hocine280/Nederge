...
public class CheckSaleEnergyRequest extends RequestAMI{
	...
	public CheckSaleEnergyRequest(AMIServer server, String sender, String receiver, SimpleDateFormat timestamp, Energy energy) {
		super(server, sender, receiver, timestamp, TypeRequestAMI.CheckSaleEnergy);
		
		this.energy = energy;
	}

	public static CheckSaleEnergyRequest fromJSON(AMIServer server, JSONObject object) throws InvalidRequestException{
		check(object);
